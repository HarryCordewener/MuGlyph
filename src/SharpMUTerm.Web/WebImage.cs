...
/// </summary>
/// <param name="LineIndex">Index into <see cref="WebPage.Lines"/> of the placeholder line.</param>
...
public sealed record WebImage(int LineIndex, string Source, string? Alt, string PlaceholderText);
